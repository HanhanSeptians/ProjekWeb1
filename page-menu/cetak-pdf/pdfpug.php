...
<?php
    ...
    $pdf->Cell(420 ,5,'Kantor Production Unit Gresik',0,1,'C');//end of line
    $pdf->Cell(130 ,5,'',0,1);
    ...
    $pdf->Cell(45 ,5,'Deskripsi Asset',1,0,'C');
   ...
   // $pdf->Cell(39 ,5,'gambar ',1,0,'C');
    $pdf->Cell(48 ,5,'Keterangan ',1,1,'C');


    $pdf->SetFont('Arial','',7);
    //Show data barang from database
    $sql = "SELECT * FROM asset where kantor='PUG'";
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            $pdf->Cell(48 ,5,$row['keterangan'],1,1,'C');
